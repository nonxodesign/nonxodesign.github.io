...
MD.modules.hero=function(e){"use strict";

//動畫縮放?
function t(e){var t=document.createElement("div");
t.className="grid__item";var i=document.createElement("a");
i.className="example-link",i.href=e.url;var r=document.createElement("img");
r.className="example-link__img",r.src=e.image;var m=document.createElement("p");
return m.className="example-link__title",
m.textContent=e.title,i.appendChild(r),i.appendChild(m), //文字置下
t.appendChild(i),t}for(var i=e.querySelector(".grid"),
r=new Masonry(i,{itemSelector:".grid__item",
	columnWidth:".grid__grid-sizer",percentPosition:!0}),
// m=[
// 	{title:"Erik Johansson",url:"https://erikjohanssonphoto.com/work/imagecats/personal/",image:"https://i.imgur.com/6Lo8oun.jpg"},
// 	{title:"Beyoncé | I Am",url:"https://iam.beyonce.com/",image:"https://i.imgur.com/HDSAMFl.jpg"},
// 	{title:"Webster Hall Timeline",url:"https://www.websterhall.com/timeline/",image:"https://i.imgur.com/VWfCPYx.jpg"},
// 	{title:"Halcyon theme",url:"https://halcyon-theme.tumblr.com/",image:"https://i.imgur.com/A1RSOhg.jpg"},{title:"RESIZE.THATSH.IT",url:"https://resize.thatsh.it/",image:"https://i.imgur.com/00xWxLG.png"},
// 	{title:"Tumblr Staff: Archive",url:"https://staff.tumblr.com/archive",image:"https://i.imgur.com/igjvRa3.jpg"},
// 	{title:"Kristian Hammerstad",url:"https://www.kristianhammerstad.com/",image:"https://i.imgur.com/Zwd7Sch.jpg"},
// 	{title:"Loading Effects for Grid Items | Demo 2",url:"https://tympanus.net/Development/GridLoadingEffects/index2.html",image:"https://i.imgur.com/iFBSB1t.jpg"}],

	a=[],o=document.createDocumentFragment(),n=0,l=m.length;n<l;n++)
{var p=t(m[n]);a.push(p),o.appendChild(p)}
imagesLoaded(o).on("progress",function(e,t){var m=t.img.parentNode.parentNode;i.appendChild(m),r.appended(m)})};
